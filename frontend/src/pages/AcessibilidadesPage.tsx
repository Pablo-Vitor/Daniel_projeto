...
import type { Acessibilidade } from "../types"; // Importe o tipo Acessibilidade
import AcessibilidadeForm from "../components/AcessibilidadesForm";
...
export default function AcessibilidadesPage() {
  ...
  async function carregar() {
    ...
    try {
      ...
      setErro(e.message ?? "Erro ao carregar acessibilidades");
    } finally {
      setLoading(false);
    }
  }
    ...
    <div className="container-page space-y-6 py-8">
      <header>
        ...
        <p className="text-gray-600">
          Crie novas acessibilidades para o sistema.
        </p>
      </header>
